...
public class IdleChanger : MonoBehaviour
{
	...
	//never used: private AnimatorStateInfo currentState;		// 現在のステート状態を保存する参照
	//never used: private AnimatorStateInfo previousState;	// ひとつ前のステート状態を保存する参照
	...
	void Start ()
	{
		...
		//never used: currentState = anim.GetCurrentAnimatorStateInfo (0);
		//never used: previousState = currentState;
